...
router.get('/cart', (req, res, next) => {
    cart(req);
    let string = "SELECT la_barang.*, (SELECT gambar.gambar FROM gambar WHERE la_barang.id_barang = gambar.id_barang ORDER BY gambar.id_barang ASC LIMIT 1) AS imageName FROM la_barang WHERE la_barang.id_barang IN (";
    try{
